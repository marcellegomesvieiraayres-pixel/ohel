...
import { Calendar, Trash2, MoreVertical, MessageSquare, Building2, GripVertical, CheckSquare, Timer } from 'lucide-react';
...
export const TaskCard: React.FC<TaskCardProps> = ({ task, onToggle, onDelete, onClick }) => {
