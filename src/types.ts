...
export const PLAN_LIMITS: Record<PlanType, { tasks: number; modules: number; reports: boolean }> = {
  BASIC: { tasks: 20, modules: 2, reports: false },
  PRO: { tasks: 100, modules: 5, reports: true },
  ADVANCED: { tasks: 1000, modules: 10, reports: true },
};
...
export const QUADRANT_LABELS: Record<EisenhowerQuadrant, { title: string; subtitle: string; color: string }> = {
  ...
  'important-not-urgent': {
    title: 'Agendar Agora',
    subtitle: 'Importante, mas Não Urgente',
